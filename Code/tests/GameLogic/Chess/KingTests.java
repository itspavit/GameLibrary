...
public class KingTests
{
    ...
    /**
     * Test the move capability of the King for cases: valid unobstructed move empty square, valid move enemy in square,
    ...
    /**
     * test that the King does not allow moving to invalid positions
     */
    @Test
