...
public class King extends ChessPiece
{
    ...
    public EMoveResult AttemptMove(Coordinate target)
    {
        ...
        if(     (x_delta == 1 && y_delta == 1) || (x_delta == 0 && y_delta == -1)||
                (x_delta == 1 && y_delta == 0) || (x_delta == -1 && y_delta == 1)||
                (x_delta == 1 && y_delta == -1)|| (x_delta == -1 && y_delta == 0)||
                (x_delta == 0 && y_delta == 1) || (x_delta == -1 && y_delta == -1))
        {
    ...
    public boolean TestForInCheck()
    {
        ...
        result = result || SubTestForInCheck(x_start, y_start - 1, needed_content);
        result = result || SubTestForInCheck(x_start, y_start + 1, needed_content);
        result = result || SubTestForInCheck(x_start -1, y_start +1, needed_content);
        result = result || SubTestForInCheck(x_start - 1, y_start , needed_content);
        result = result || SubTestForInCheck(x_start -1, y_start -1, needed_content);
